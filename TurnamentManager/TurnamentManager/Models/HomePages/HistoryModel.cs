...
namespace TurnamentManager.Models
{
    public class HistoryModel : INotifyPropertyChanged
    {
        ...
        public HistoryModel(INavigation navigation)
        {
        ...
        public async Task GetFrames(List<Frame> frames)
        {
            ...
            foreach (var tournament in tournaments.Where(tournament => tournament.Finished == 1))
            {
        ...
        private Frame MakeFrameAsync(Tournament tournament)
        {
            ...
            //frame.GestureRecognizers.Add(tap); TODO make sure that user can no longer modify results of tournament
